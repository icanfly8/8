var rule = {
    ...
    class_url:'音乐&歌曲&MV&演唱会&舞蹈&健身&帕梅拉&广场舞&风景4K&纪录片',
    filterable: 1,
    filter_url: '&keyword={{fl.tid}}&page=fypage&duration={{fl.duration}}&order={{fl.order}}',
    filter_def:{
        音乐:{tid:'音乐'},歌曲:{tid:'歌曲'},MV:{tid:'MV'},演唱会:{tid:'演唱会'},舞蹈:{tid:'舞蹈'},健身:{tid:'健身'},帕梅拉:{tid:'帕梅拉'},广场舞:{tid:'广场舞'},风景4K:{tid:'风景4K'},纪录片:{tid:'纪录片'}
    },
    filter:{
